...
def test_a_level_3_round_limit():
    """测试A级3局限制逻辑"""
    print("开始测试A级3局限制逻辑...")
    print("=" * 60)
    ...
    print("=== 阶段1: 开始新游戏 ===")
    game_state = engine.start_new_game("test_a_level_limit", players, current_level=2)
    print(f"✓ 游戏创建成功")
    ...
    # 测试游戏清理
    remove_result = engine.remove_game("test_a_level_limit")
    print(f"✓ 游戏清理")
